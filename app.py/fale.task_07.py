...
for quantiti_price in sales[code_goods]:
        total_price += total_price + quantiti_price['quantity'] * quantiti_price['price']     
        total_quantiti += quantiti_price['quantity']
        
print(name_goods, '-', total_quantiti, 'шт, общей стоимостью', total_price, 'руб')
